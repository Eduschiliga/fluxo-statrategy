package com.eduardo.fluxostatrategy.service.strategy.impl.protocolar.geral.naorobotizada;
...
@Component
public class DestinoFgtsSemRpaStrategy implements DestinoStrategy {
    private static final Set<Long> LINHAS_FLUXO = Set.of(160L);
    ...
    public StatusFluxo calcularDestino(StatusFluxo statusFluxo) {
        System.out.println("Calculando destino FLUXO FGTS sem RPA - GERAL");
